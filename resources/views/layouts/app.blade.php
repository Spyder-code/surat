            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  ...
                  <div>
                    <small class="designation text-muted" style="text-transform: uppercase;letter-spacing: 1px;">{{ Auth::user()->username }}</small>
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            ...
            <a href="https://diskominfo.mojokertokab.go.id/" target="_blank">DISKOMINFO KABUPATEN MOJOKERTO</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
